...
class GraphicsPatcher:
    ...
    def apply_patch(self):
        ...
        self.patcher.patch(os.path.join(self.patches_dir, "draw_hijack_backpoly.asm"), "RF_Backpoly", 1)
    ...
    def __generate_shader_patch_symbols(self):
        ...
        self.__add_symbol("disable_layer_backpoly_flag", self.patch_shared_mem)
